...
export default function TopbarEmployee() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      axios
        .get("/api/search", { params: { q: query, role: "EMPLOYEE" }, signal: controller.signal })
              ...
              {loadingMessages ? (
                ...
                recentMessages.map((message) => (
                  <DropdownMenuItem
                    ...
                    onClick={() => { handleMarkRead(message.id); router.push(`/user/notifications?messageId=${message.id}`); }}
                  >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuItem asChild>
              <a href="/user/profile" className="cursor-pointer">My Profile</a>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
